using DotNetCore.API.Common.API.Common.Attributes;
using DotNetCore.API.Common.API.Common.Middlewares;
using DotNetCore.API.Common.API.Common.Settings;
using DotNetCore.API.Common.API.Swagger;
using DotNetCore.API.Common.IoC.Configuration.DI;
...
namespace DotNetCore.API.Common.API
{
