using AutoMapper;
using DotNetCore.API.Common.API.Controllers.V1;
using DotNetCore.API.Common.API.DataContracts.Requests;
using DotNetCore.API.Common.API.DataContracts;
...
namespace DotNetCore.API.Common.API.Tests.Controllers.ControllerTests.V1
{
    [TestClass]
